...
enum Key
{
	...
	KEY_MOUSE_LEFT_BUTTON, KEY_MOUSE_MIDDLE_BUTTON, KEY_MOUSE_RIGHT_BUTTON, KEY_MOUSE_WHEEL_UP, KEY_MOUSE_WHEEL_DOWN
};
...
enum AnalogInput
{
	MOUSE_AXIS_X_RELATIVE, MOUSE_AXIS_Y_RELATIVE, MOUSE_AXIS_X_ABSOLUTE, MOUSE_AXIS_Y_ABSOLUTE
};
