...
FrameBuffer::FrameBuffer(Engine *engine) : Object(engine), GraphicsResource(engine->GetRenderer()), depthRenderBuffer(0), depthTexture(nullptr)
{
...
void FrameBuffer::SetDepthBufferTexture(Texture *depthTexture)
{
