...
vec2 FireCube::operator*(const vec2 &a, const float &b)
{
    return vec2(a.x * b, a.y * b);
}
vec2 FireCube::operator*(const float &a, const vec2 &b)
{
...
float vec2::Cross(const vec2 &p, const vec2 &q)
{
...
vec2 vec2::TransformCoordinate(mat4 m)
{
...
vec2 vec2::TransformNormal(mat4 m)
{
    mat4 t = m;
